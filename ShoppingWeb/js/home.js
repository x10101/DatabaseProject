document.addEventListener("DOMContentLoaded", () => {
  ...
  function setupSearch(products) {
    ...
    const searchButton = document.querySelector(
      ".search-container button:not(#clear-search)"
    ); // 搜尋按鈕
    ...
    function performSearch() {
      ...
      brandSections.forEach((brand) => {
        ...
        const productsUnderBrand =
          productSection.querySelectorAll(".product-item");

        // 判斷是否有商品顯示
        const isBrandVisible = Array.from(productsUnderBrand).some(
